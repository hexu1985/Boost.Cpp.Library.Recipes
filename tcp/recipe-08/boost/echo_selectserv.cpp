...
void on_accept(asio::io_context& io, asio::ip::tcp::acceptor& acceptor, socket_ptr sock, 
        const boost::system::error_code& ec);

void start_accept(asio::io_context& io, asio::ip::tcp::acceptor& acceptor) {
    socket_ptr sock(new asio::ip::tcp::socket(io));
    acceptor.async_accept(*sock, 
            [&io, &acceptor, sock](const boost::system::error_code& ec) {
                on_accept(io, acceptor, sock, ec);
            });
}
